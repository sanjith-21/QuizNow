...
<head>
    ...
    <style>
        * {
        ...
        .tablestyle tr:nth-child(odd) button {
            background-color: #0d8b66;
            color: black;
        }

        .tablestyle tr:nth-child(even),
        .tablestyle tr:nth-child(even) button {
            background-color: #0ead88;
            color: black;
        }
...
<body>
    ...
    if (isset($_POST['submit1'])) {
        ...
        $uemail = $_POST["uemail"];
        try {
            $resultt = $con->query("update login set fname='$fname',lname='$lname',email='$uemail' where uid='$uid'");
            if ($resultt) {
            ...
            <table cellspacing="10" style="width:100%;">
                <tr>
                    <td align="center">
                        ...
                        ?>
                        <img src="<?php echo $photo; ?>" width="90%" height="170" alt="no image"
    ...
    if ($utype == "STUDENT") {
        ...
        <div class="tabcontent">
            <fieldset class="scroll">
                <legend>
                    <font size="6pt"><b>SETTINGS</b></font>
                </legend>
