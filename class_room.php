    ...
    if ($utype === "STUDENT") {
        ...
        <div class="menu">
            <fieldset style="background-color: #0ead88;">
                ...
                <div class="scroll" style="height:170px;">
                    <ul type='none'>
                        <?php
                        $result1 = $con->query("select * from qlist where cid='" . $_REQUEST["no"] . "' and status='COMPLETED'");
                        if ($rows = $result1->fetch_assoc()) {
                            do {
                                ?>
                                <li>
                                    <?php echo $rows["qname"]; ?><br>
                                    <?php echo $rows["qdate"]; ?>
                                </li>
                                <?php
                ...
                <div class="scroll" style="height:170px;">
                    <ul type='none'>
                        <?php
                        $result2 = $con->query("select * from qlist where cid='" . $_REQUEST["no"] . "' and status='UPCOMING'");
        ...
        <div class="menu">
            <fieldset style="background-color: #0ead88;" class="scroll">
                <?php
                $result1 = $con->query("select * from class_room where tid='$uid' AND cid='" . $_REQUEST["no"] . "'");
                while ($rows = $result1->fetch_assoc()) {
                    $classname = $rows["cname"];
                    ...
                    <p style="width:59%; float:right;">
                        <?php echo $_REQUEST["no"]; ?>
                    </p>
                    <br><br>
                    ...
                    <div style="width:100%; overflow-y: scroll;height:300px;">
                        <table cellspacing="10" style="width:100%;">
                            ...
                            sort($students);
                            for ($i = 0; $i < $count; $i++) {
                                $result2 = $con->query("select * from login where uid like '$students[$i]'");
                                while ($rows = $result2->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <button style="width:80%; background-color:#0ead88; border:none;"
                                                onclick='location.href="<?php echo $delete; ?>"'>
                                                <center>
                                                    <img src="trash1.png" style="width:80%;height:30px;">
                                                </center>
                                            </button>
                                        </td>
                                    </tr>
                    ...
                    <div id="view1">
                        <form method="post" action="joincreate.php">
                            ...
                            <textarea style="resize:none; font-size:20px" width="80%" name="students" rows="5"
                                cols="20"></textarea>
            ...
            <table class="style1" cellpadding=20 style="border-collapse: collapse;">
                <tr>
                    ...
                    if ($utype == "STUDENT"){
                        ...
                        ?>
                        <td>
                            <button class="quizbutton" onclick="createquiz('<?php echo $_REQUEST["no"]; ?>')">CREATE
                                QUIZ</button>
                        </td>
                        <?php
                    }
                    ...
                    while ($rows = $result3->fetch_assoc()){
                        ...
                        <td>
                            <button class="quizbutton"
                                onclick="opentarget('<?php echo $rows["qid"]; ?>','<?php echo $utype; ?>')"><?php echo $rows["qname"]; ?></button>
                        </td>
                        <?php
                        if ($count % 4 === 3) {
                            ?>
